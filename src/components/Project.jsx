...
const Project = ({ project }) => {
  ...
  return (
    ...
    <div className="col" style={{maxWidth:"400px"}}>
      <div className="card border border-dark border-4 rounded-4">
        <img src={project.url} className="card-img-top  border-3 rounded-3" alt={project.name} style={{height:"30vh"}} />
